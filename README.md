...
- 🧭 **Zone summary** *(opt-in, off by default)* — a compact overlay panel with live counts for the current zone: rares, uniques, chests, and exits. Anchor it to any corner; its toggle sits prominently at the top of Settings.
